...
public class ComponentProperty implements Serializable {
    ...
    @Embedded
    private ComponentPropertyOptions options = new ComponentPropertyOptions();
    ...
    public ComponentPropertyOptions getOptions() {
        return options;
    }

    public void setOptions(ComponentPropertyOptions options) {
    ...
    public int hashCode() {
        ...
        hash = 89 * hash + (this.required ? 1 : 0);
    ...
    public boolean equals(Object obj) {
        ...
        final ComponentProperty other = (ComponentProperty) obj;
    ...
    public String toString() {
        return "ComponentProperty{" + "name=" + name + ", label=" + label + ", type=" + type 
