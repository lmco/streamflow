...
public class ResourceResource {
    ...
    @GET
    @Path("/{resourceId}/config")
    @Produces(MediaType.APPLICATION_JSON)
    public ResourceConfig getResourceConfig(@PathParam("resourceId") String resourceId) {
        return resourceService.getResource(resourceId).getConfig();
    }
}
