...
@Singleton
public class MongoDiskFileContentDao implements FileContentDao {

    public static Logger LOG = LoggerFactory.getLogger(MongoDiskFileContentDao.class);

    @Inject
    public MongoDiskFileContentDao() {
    }
