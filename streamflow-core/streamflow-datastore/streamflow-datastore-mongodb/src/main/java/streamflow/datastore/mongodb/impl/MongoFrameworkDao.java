...
@Singleton
public class MongoFrameworkDao extends MongoDao<Framework, String>
        implements FrameworkDao {

    @Inject
    public MongoFrameworkDao(Datastore datastore) {
        super(datastore, Framework.class);
    }
